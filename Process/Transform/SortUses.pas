...
begin
  ...
  if not FormatSettings.Transform.SortProgramUses then
    exit{ other - program, package or library section };
  ...
  try
    ...
    begin
      ...
      begin
        ...
        lbStartUsesItem := False{ a uses item contains exactly one identifier.
      ...
      if lcToken.TokenType = ttDot then
        ...
        begin
          lcCurrentSection.AddToken(lcToken);
          lcToken := lcToken.NextToken;
        end// delphi.net dotted unit name
      ;
    end;
