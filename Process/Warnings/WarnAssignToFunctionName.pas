...
begin
  ...
  begin
    ...
    begin
      ...
      Result := GetIdentifierBeforeAssign(lcChildNode)// go inside the brackets - should be a designator in there
...
begin
  ...
  begin
    ...
    for liLoop := 0 to lcNode.ChildNodeCount - 1 do
      WarnAllAssigns(psFnName, lcNode.ChildNodes[liLoop])// look at all nodes under here
  ;
end;
