...
type
  ...
  public
    ...
    function IsSolidOrComment: boolean;
    ...
    function NextSolidTokenOrComment: TSourceToken;
...
function TSourceToken.IsSolidOrComment: boolean;
begin
  Result := not (TokenType in NotSolidTokensButComment);
end;
...
function TSourceToken.NextSolidTokenOrComment: TSourceToken;
begin
  Result := NextToken;

  while (Result <> nil) and (not Result.IsSolidOrComment) do
    Result := Result.NextToken;
end;
